...
class GenerateUserName
{
    ...
    public function generateUserName(string $fistName, string $lastName): string
    {
        return self::getuserName($fistName,$lastName);
    }


    private static function getuserName(string $firstName, string $lastName) : string {
        $count = 0;

        $firstName = self::convertSpecialSimple($firstName);
        $lastName = self::convertSpecialSimple($lastName);
        do{
    ...
    private static function convertSpecialSimple($txt)
    {
        $transliterationTable = array(
            ...
            'ю' => 'ju', 'Ю' => 'ju', 'я' => 'ja', 'Я' => 'ja');
        $text = str_replace(array_keys($transliterationTable), array_values($transliterationTable), $txt);
        return $text;
    }
}
